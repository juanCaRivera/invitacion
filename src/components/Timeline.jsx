...
import cenaImg from '../assets/cena.png';
import brindisImg from '../assets/brindis.png';
...
function EventBlock({ event, align }) {
  ...
  return (
    <div
      className={`flex min-w-0 max-w-md flex-col gap-2 ${isRight
      ...
      <div className="container-narrow">
        <div className="relative py-16 md:py-20">
          ...
          <div className="relative">
            ...
            <div
              className="pointer-events-none absolute inset-y-0 left-1/2 z-0 w-[2px] -translate-x-1/2"
              style={{ backgroundColor: 'rgba(184, 147, 77, 0.2)' }}
              aria-hidden
            />
            ...
            <motion.div
              ...
              className="pointer-events-none absolute left-1/2 top-0 z-0 w-[2px] origin-top -translate-x-1/2"
              style={{ backgroundColor: '#b8934d' }}
            />

            {/* Glowing light traveling down */}
            <motion.div
              animate={{ y: ['0%', '100%'] }}
              transition={{ duration: 3, repeat: Infinity, ease: 'linear' }}
              className="pointer-events-none absolute left-1/2 top-0 z-0 h-24 w-[4px] -translate-x-1/2 blur-md"
              style={{ backgroundColor: 'rgba(184, 147, 77, 0.4)' }}
              aria-hidden
            />
